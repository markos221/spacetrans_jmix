...
import { Company } from "../../jmix/entities/Company";
...
class CompanyEditComponent extends React.Component<
  Props & WrappedComponentProps
> {
  dataInstance = instance<Company>(Company.NAME, {
    view: "company-fetch-plan",
  ...
  fields = ["name", "registrationId", "companyType", "email", "grade"];
  ...
  isNewEntity = () => {
    return this.props.entityId === CompanyManagement.NEW_SUBPATH;
  };
  ...
  render() {
    if (this.updated) {
      return <Redirect to={CompanyManagement.PATH} />;
    }
      ...
      <Card className="narrow-layout">
        ...
        >
          ...
          <Form.Item style={{ textAlign: "center" }}>
            <Link to={CompanyManagement.PATH}>
  ...
  componentDidMount() {
    if (this.isNewEntity()) {
      this.dataInstance.setItem(new Company());
    } else {
...
export default injectIntl(injectMainStore(observer(CompanyEditComponent)));
