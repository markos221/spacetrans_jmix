...
import { Individual } from "../jmix/entities/Individual";
...
class IndividualEditComponent extends React.Component<
  Props & WrappedComponentProps
> {
  dataInstance = instance<Individual>(Individual.NAME, {
    view: "individual-fetch-plan",
  ...
  fields = ["firstName", "lastName", "name", "email", "grade"];
  ...
  isNewEntity = () => {
    return this.props.entityId === IndividualManagement.NEW_SUBPATH;
  };
  ...
  render() {
    if (this.updated) {
      return <Redirect to={IndividualManagement.PATH} />;
    }
      ...
      <Card className="narrow-layout">
        ...
        >
          ...
          <Form.Item style={{ textAlign: "center" }}>
            <Link to={IndividualManagement.PATH}>
  ...
  componentDidMount() {
    if (this.isNewEntity()) {
      this.dataInstance.setItem(new Individual());
    } else {
...
export default injectIntl(injectMainStore(observer(IndividualEditComponent)));
