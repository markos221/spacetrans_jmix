...
class PlanetEditComponent extends React.Component<
  Props & WrappedComponentProps
> {
  dataInstance = instance<Planet>(Planet.NAME, {
  ...
  isNewEntity = () => {
    return this.props.entityId === PlanetManagement.NEW_SUBPATH;
  };
  ...
  render() {
    if (this.updated) {
      return <Redirect to={PlanetManagement.PATH} />;
    }
  ...
  componentDidMount() {
    if (this.isNewEntity()) {
      this.dataInstance.setItem(new Planet());
    } else {
...
export default injectIntl(injectMainStore(observer(PlanetEditComponent)));
